...
SECTION_KEYWORDS: dict[str, list[str]] = {
    ...
    "experience": [
        ...
        "deneyim",
        "iş deneyimi",
        "iş geçmişi",  # FIX 5: added — common Turkish CV heading
        "çalışma geçmişi",
        "kariyer",
        "kariyer geçmişi",  # FIX 5: added variant
    ],
    "education": [
        "education",
        "academic background",
        ...
        "öğrenim",
        "akademik geçmiş",
        "eğitim bilgileri",  # FIX 5: added variant
        "mezuniyet",  # FIX 5: added — graduation heading used in some CVs
    ],
    "skills": [
        "skills",
        "technical skills",
        ...
        "yetkinlikler",
        "teknik beceriler",
        "diller",  # FIX 5: added — "diller" (languages) often appears as own heading
        "languages",  # FIX 5: added
    ],
    "projects": [
        "projects",
        "personal projects",
